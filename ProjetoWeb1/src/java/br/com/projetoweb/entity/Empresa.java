...
public class Empresa implements Serializable {
    ...
    @JoinColumn(name = "id_responsavel", referencedColumnName = "id_cliente")
    ...
    public Cliente getIdResponsavel() {
        return idResponsavel;
    }

    public void setIdResponsavel(Cliente idResponsavel) {
    ...
    public String toString() {
        return "br.com.projetoweb.entity.Empresa[ idEmpresa=" + idEmpresa + " ]";
    }
